...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinEuroTestFramework
    pass

class ExampleTest(BitcoinEuroTestFramework):
    # Each functional test is a subclass of the BitcoinEuroTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinEuroTestFramework class so other tests can use it."""
