...
from test_framework.test_framework import BitcoinEuroTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (BitcoinEuroTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that bitcoineuro has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("bitcoineurod has not been built with zmq enabled.")
