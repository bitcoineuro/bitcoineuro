...
class BIP66Test(BitcoinEuroTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bitcoineurod is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bitcoineurod produces more specific reject
            # reasons.
