...
unlocked to sign the BitcoinEuro-Qt.app bundle.
...
allowing somebody to distribute a BitcoinEuro-Qt.app or bitcoineuro-qt-setup.exe with a valid
...
that the bitcoineuro-qt.exe file inside the installer had not been tampered with.
