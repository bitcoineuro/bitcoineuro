BitcoinEuro version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoineuro/files/BitcoinEuro/bitcoineuro-0.5.4/
...
http://gitorious.org/bitcoineuro/bitcoineurod-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinEuro-Qt notifications under Growl 1.3.
Increase required age of BitcoinEuro-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinEuro properly when installing BitcoinEuro-Qt over it. (Windows)
