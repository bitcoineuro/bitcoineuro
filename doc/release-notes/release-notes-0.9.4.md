BitcoinEuro Core version 0.9.4 is now available from:

  https://bitcoineuro.org/bin/0.9.4/
...
this update is incompatible with the BitcoinEuro system and could lead to consensus
forks.

BitcoinEuro Core released binaries from https://bitcoineuro.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoineuro/+archive/ubuntu/bitcoineuro
- A third-party or self-compiled BitcoinEuro Core

upgrade to BitcoinEuro Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
