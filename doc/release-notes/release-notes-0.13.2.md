BitcoinEuro Core version 0.13.2 is now available from:

  <https://bitcoineuro.org/bin/bitcoineuro-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoineuro-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoineuro-tx to create v2 transactions (btcdrak)
