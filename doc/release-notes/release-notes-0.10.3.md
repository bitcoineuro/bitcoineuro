BitcoinEuro Core version 0.10.3 is now available from:

  <https://bitcoineuro.org/bin/bitcoineuro-core-0.10.3/>
...
(see https://github.com/bitcoineuro/bitcoineuro/pull/6793, as well as the 0.11.0
