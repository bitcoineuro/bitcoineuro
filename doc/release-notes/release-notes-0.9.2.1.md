BitcoinEuro Core version 0.9.2.1 is now available from:

  https://bitcoineuro.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BCE to 0.01 BCE
...
- Fix "Start bitcoineuro on system login"
