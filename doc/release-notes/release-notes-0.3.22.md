Download URL: https://sourceforge.net/projects/bitcoineuro/files/BitcoinEuro/bitcoineuro-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BCE fee schedule (users still pay 0.01 BCE per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoineuro00 - #bitcoineuro99
