BitcoinEuro Core version 0.10.4 is now available from:

  <https://bitcoineuro.org/bin/bitcoineuro-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoineuro-tx into its own package
- #6953 `dfe0d4d` Include bitcoineuro-tx binary on Debian/Ubuntu
