BitcoinEuro-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoineuro/files/BitcoinEuro/bitcoineuro-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinEuro
...
New/changed settings (command-line or bitcoineuro.conf file)
--------------------------------------------------------
