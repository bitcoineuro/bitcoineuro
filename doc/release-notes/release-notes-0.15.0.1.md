BitcoinEuro Core version *0.15.0.1* is now available from:

  <https://bitcoineuro.org/bin/bitcoineuro-core-0.15.0.1/>

and

  <https://bitcoineurocore.org/bin/bitcoineuro-core-0.15.0.1/>
...
installer (on Windows) or just copy over `/Applications/BitcoinEuro-Qt` (on Mac)
or `bitcoineurod`/`bitcoineuro-qt` (on Linux).
