...
#ifndef BITCOINEURO_CONSENSUS_CONSENSUS_H
#define BITCOINEURO_CONSENSUS_CONSENSUS_H
...
// version. The former uses BitcoinEuro parameters, but if this fork is a fork
...
#endif // BITCOINEURO_CONSENSUS_CONSENSUS_H
