...
#ifndef BITCOINEURO_QT_BITCOINEUROUNITS_H
#define BITCOINEURO_QT_BITCOINEUROUNITS_H
...
/** BitcoinEuro unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinEuroUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinEuroUnits(QObject* parent);

    /** BitcoinEuro units.
      @note Source: https://en.bitcoineuro.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        BCE,
        mBCE,
...
typedef BitcoinEuroUnits::Unit BitcoinEuroUnit;

#endif // BITCOINEURO_QT_BITCOINEUROUNITS_H
