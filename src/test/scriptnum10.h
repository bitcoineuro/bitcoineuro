...
#ifndef BITCOINEURO_TEST_SCRIPTNUM10_H
#define BITCOINEURO_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from BitcoinEuro Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINEURO_TEST_BIGNUM_H
