...
#ifndef BITCOINEURO_WALLET_WALLET_H
#define BITCOINEURO_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoineuro node, and set to 0 for transactions that were created
...
#endif // BITCOINEURO_WALLET_WALLET_H
