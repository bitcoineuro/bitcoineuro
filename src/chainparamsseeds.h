#ifndef BITCOINEURO_CHAINPARAMSSEEDS_H
#define BITCOINEURO_CHAINPARAMSSEEDS_H
/**
 * List of fixed seed nodes for the bitcoineuro network
...
#endif // BITCOINEURO_CHAINPARAMSSEEDS_H
